...
from gen_ai.pose.pose import Poses
from gen_ai.pose.yolov11.yolov11_model_config import YOLOv11ModelConfig
from gen_ai.pose.yolov11.yolov11_output_parsers import parse_yolov11_pose_output
...
class YOLOv11_Pose:
    ...
    def detect(self, image: Image.Image) -> Poses:
        """
