...
class FluxInpaintPipeline(
    ...
    def encode_prompt(
        ...
        if lora_scale is not None and isinstance(self, FluxLoraLoaderMixin):
            self._lora_scale = (  # pylint: disable=attribute-defined-outside-init
                lora_scale
            )
    ...
    def get_timesteps(  # pylint: disable=unused-argument
    ...
    def __call__(  # pylint: disable=dangerous-default-value
        ...
        self._guidance_scale = (  # pylint: disable=attribute-defined-outside-init
            guidance_scale
        )
        self._joint_attention_kwargs = (  # pylint: disable=attribute-defined-outside-init
        ...
        self._num_timesteps = len(  # pylint: disable=attribute-defined-outside-init
            timesteps
        )
        # handle guidance
